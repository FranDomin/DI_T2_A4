...
public class AgendaViewController implements Initializable 
{
    ...
    private void onActionButtonNuevo(ActionEvent event) 
    {
        try
        {
            ...
            FXMLLoader(getClass().getResource("InsertarPersonaView.fxml"));
            ...
            InsertarPersonaViewController personaDetalleViewController = (InsertarPersonaViewController) fxmlLoader.getController();
